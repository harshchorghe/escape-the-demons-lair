...
export const LobbyScreen: React.FC<LobbyScreenProps> = ({
  ...
  return (
    <div className="w-full">
      ...
      <section className="w-full max-w-[1400px] mx-auto px-4 pb-8 lg:pb-10">
        <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1.1fr)_minmax(360px,0.9fr)] items-center gap-6 lg:gap-10">
          ...
          <div className="w-full flex items-center justify-center lg:justify-end">
            <div className="relative h-[420px] w-full max-w-[480px] lg:h-[540px]">
              <LobbyBackground />
            </div>
          </div>
        </div>
