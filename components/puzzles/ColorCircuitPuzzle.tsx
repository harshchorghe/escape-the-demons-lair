    ...
    <div className="space-y-5 bg-black/40 backdrop-blur-md border border-cyan-900/40 rounded-2xl p-5 text-white">
      ...
      {showHint && (
        <div className="p-3 bg-amber-950/40 border border-amber-800/40 rounded-xl text-xs font-mono text-amber-300 space-y-1">
          <p>💡 <strong>Hint:</strong> Click the middle straight & corner tiles so the blue laser flows straight down, while red flows horizontally!</p>
          <button
            onClick={handleAutoSolve}
            className="mt-1 text-[11px] underline text-amber-400 hover:text-white cursor-pointer"
          >
            Bypass Power Circuit (Auto Solve)
          </button>
        </div>
      )}
